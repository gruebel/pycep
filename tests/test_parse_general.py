...
def test_parse_extension() -> None:
    # given
    sub_dir_path = EXAMPLES_DIR / "complex/10-extension"
    file_path = sub_dir_path / "main.bicep"
    expected_result = json.loads((sub_dir_path / "result.json").read_text())
...
def test_parse_nullable_type() -> None:
    # given
    sub_dir_path = EXAMPLES_DIR / "complex/12-nullable-type"
    file_path = sub_dir_path / "main.bicep"
    expected_result = json.loads((sub_dir_path / "result.json").read_text())
...
def test_parse_import() -> None:
    # given
    sub_dir_path = EXAMPLES_DIR / "complex/13-import"
    file_path = sub_dir_path / "main.bicep"
    expected_result = json.loads((sub_dir_path / "result.json").read_text())
...
def test_parse_type_decorator() -> None:
    # given
    sub_dir_path = EXAMPLES_DIR / "complex/14-type-decorator"
    file_path = sub_dir_path / "main.bicep"
    expected_result = json.loads((sub_dir_path / "result.json").read_text())
